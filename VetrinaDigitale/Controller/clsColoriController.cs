...
{
    public class clsColoriController
    {
        private string dbName;
        private ADOSQLServer2017 ado;

        public clsColoriController()
        {
        ...
        public DataTable GetAllColori()
        {
            string query = "SELECT idColore, colore FROM COLORI ORDER BY colore";
