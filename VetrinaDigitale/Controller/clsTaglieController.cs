...
{
    public class clsTaglieController
    {
        private string dbName;
        private ADOSQLServer2017 ado;
        public clsTaglieController()
        {
        ...
        public DataTable GetAllTaglie()
        {
            string query = "SELECT idTaglia, taglia FROM TAGLIE ORDER BY taglia";
